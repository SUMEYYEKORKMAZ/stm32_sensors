...
//static float accelScalingFactor, gyroScalingFactor, ax, ay, az, roll, pitch, yaw;

I2C_HandleTypeDef i2cHandler1;
float accelScalingFactor1 = 0.0f;
float gyroScalingFactor1 = 0.0f;
float accelx = 0.0f;
float accely = 0.0f;
float accelz = 0.0f;
float gyrox = 0.0f;
...
void MPU9250_Get_Accel_Cali(ScaledData_Def *CaliDef) {
	//_Accel_Cali(6,8,20,15,31,24);--------kalibreyi bi hallet agam
