...
extern I2C_HandleTypeDef i2cHandler1;

extern float accelScalingFactor1;
extern float gyroScalingFactor1;
extern float ax1;
extern float ay1;
extern float az1;
...
enum gyro_FullScale_ENUM {
	FS_SEL_250 = 0x00, FS_SEL_500 = 0x01, FS_SEL_1000 = 0x02, FS_SEL_2000 = 0x03
};
//4- Accelerometer Full Scale Range ENUM (1g = 9.81m/s2)
enum accel_FullScale_ENUM {
	AFS_SEL_2g = 0x00, AFS_SEL_4g, AFS_SEL_8g, AFS_SEL_16g
};
